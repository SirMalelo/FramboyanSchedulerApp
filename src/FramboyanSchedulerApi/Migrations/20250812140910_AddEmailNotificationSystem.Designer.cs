...
namespace FramboyanSchedulerApi.Migrations
{
    ...
    [Migration("20250812140910_AddEmailNotificationSystem")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FramboyanSchedulerApi.Models.ClassModel", b =>
                {
                    ...
                    b.Property<bool>("AllowPackagePurchase")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<int>("PackageClassCount")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FramboyanSchedulerApi.Models.PaymentSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<bool>("AllowDropInPayments")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("AllowMembershipPayments")
                        .HasColumnType("INTEGER");

                    b.Property<bool>("AllowPackagePayments")
                        .HasColumnType("INTEGER");
                    ...
                    b.Property<decimal>("RefundFeePercentage")
                        .HasColumnType("TEXT");
                    ...
                    b.Property<bool>("RequirePaymentForBooking")
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FramboyanSchedulerApi.Models.PaymentTransaction", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");
            ...
            modelBuilder.Entity("FramboyanSchedulerApi.Models.StripeSettings", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("INTEGER");

                    b.Property<decimal>("AdditionalFeeFixed")
                        .HasColumnType("TEXT");

                    b.Property<decimal>("AdditionalFeePercentage")
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("FramboyanSchedulerApi.Models.PaymentTransaction", b =>
                {
                    ...
                    b.HasOne("FramboyanSchedulerApi.Models.Membership", "Membership")
                        .WithMany()
